...
Matrix3x3 parse_transformation(const json &node) {
    ...
    for (auto it = transform_it->begin(); it != transform_it->end(); it++) {
	    ...
	    Matrix3x3 rotateMatrix = Matrix3x3::identity();
            ...
            // construct a shear matrix (x direction) and composite with F
            ...
            // construct a shear matrix (y direction) and composite with F
